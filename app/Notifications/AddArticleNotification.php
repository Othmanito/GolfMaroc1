...
class AddArticleNotification extends Notification
{
  use Queueable;
  ...
  public function toMail($notifiable)
  {
      return (new MailMessage)
                  ->subject('Création d\'un nouveau article ')
                  ->line('Bienvenue dans GolfMaroc-APP votre application de gestion des points de vente du groupe GolfMaroc .')
                  ->line('Nous vous informons qu\'un nouveau article a été créé en attente de validation de la part de l\'administrateur ')
