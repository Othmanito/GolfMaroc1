...
@section('title') Transfert OUT de stock @endsection

@section('main_content')
    <h3 class="page-header">Liste des Transferts de stock depuis le magasin Principal</h3>

    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('magas.home') }}">Dashboard</a></li>
        <li class="breadcrumb-item ">Gestion des transactions</li>
        <li class="breadcrumb-item active">
            <a href="{{ route('magas.transfertOUTs') }}">Liste des transferts de stock</a>
        </li>
    </ol>
                        ...
                        @foreach( $data as $item )
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="{{ Route('magas.transfertOUT',['p_id' => $item->id_transaction ]) }}"
